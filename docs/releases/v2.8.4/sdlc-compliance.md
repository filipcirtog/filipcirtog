SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.8.4
=================================================================
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v2.8.4, 2024-08-14.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.8.4 SIGNATURE_REPO=mongodb/signatures
    ```
