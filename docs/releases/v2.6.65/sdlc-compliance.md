SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.6.65
=================================================================
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v2.6.65, 2024-08-15.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.6.65 SIGNATURE_REPO=mongodb/signatures
    ```
