SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.6.62
=================================================================
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v2.6.62, 2024-08-15.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.6.62 SIGNATURE_REPO=mongodb/signatures
    ```
