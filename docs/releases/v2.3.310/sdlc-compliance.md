SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.3.310
=================================================================
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v2.3.310, 2024-08-16.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.3.310 SIGNATURE_REPO=mongodb/signatures
    ```
