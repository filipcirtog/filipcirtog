SSDLC Compliance Report: Atlas Kubernetes Operator Manager v2.2.25
=================================================================
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v2.2.25, 2024-08-16.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:2.2.25 SIGNATURE_REPO=mongodb/signatures
    ```
